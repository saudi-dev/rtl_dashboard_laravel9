...
@section('content')
    ...
    <div class="row row-sm">
        <div class="col-sm-12 col-xl-2 col-lg-4 col-md-6">
            <div class="card ">
                <div class="card-body">
                    <div class="counter-status d-flex md-mb-0">
                        ...
                        <div class="mr-auto">
                            ...
                            <p class="text-muted mb-0 tx-11"><i class="si si-arrow-up-circle text-success mr-1"></i>increase
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="main-profile-overview">
                            ...
                            <div class="row">
                                <div class="col-md-4 col mb20 text-center">
                                    <h5>9</h5>
                                    <h6 class="text-small text-muted mb-0">Admin User</h6>
                                </div>
                                <div class="col-md-4 col mb20 text-center">
                                    <h5>583</h5>
                                    <h6 class="text-small text-muted mb-0">Normal User</h6>
                                </div>
                                <div class="col-md-4 col mb20 text-center">
                                    <h5>48</h5>
                                    <h6 class="text-small text-muted mb-0">Blocked User</h6>
                                </div>
                            </div>
                            <hr class="mg-y-30">
                            <div class="tabs-menu ">
                                ...
                                <ul class="nav nav-tabs profile navtab-custom panel-tabs">
                                    <li class="active">
                                        <a href="#general" data-toggle="tab" aria-expanded="true"> <span
                                                class="visible-xs"><i class="las la-user-circle tx-16 mr-1"></i></span>
                                            <span class="hidden-xs">البيانات الرئيسية</span> </a>
                                    </li>
                                    <li class="">
                            ...
                            <div class="tab-content border-left border-bottom border-right border-top-0 p-4">
                                <div class="tab-pane active" id="general">
                                    <h4 class="text-primary m-b-5 tx-14">الشعارات</h4>
                                    <p class="m-b-5"> eleifend ac, enim.</p>
                                    <div class="m-t-30">
                                        <hr>
                                        <div class=" p-t-10">
                                            <h4 class="text-primary m-b-5 tx-14">البيانات العامة</h4>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="border p-1 card thumb">
                                                <a href="#" class="image-popup" title="Screenshot-2"> <img
                                                        src="{{ URL::asset('assets/img/photos/7.jpg') }}"
                                ...
                                <div class="tab-pane" id="settings">
                                    ...
                                    <form autocomplete="off" method="POST" role="form" enctype="multipart/form-data"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="أبها - المملكة العربية السعودية"
